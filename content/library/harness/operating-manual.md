...
sourceMtime: '2026-08-03T01:26:45.999Z'
...
contentHash: 'sha256:fb7b2d138e8438c492a06de0a23a545858e24200825a0a1f448bd7d5e4c5de1a'
---
...
extra review to risk tier (`AGENT_ANATOMY.md` §6).
...
| Architecture, cross-module, high ambiguity (T2) | `/deep-plan`; independent fresh-context review; rollback plan; walk the T2/T3 checklist (`AGENT_ANATOMY.md` §6.1) |
...
| New agent project | `/new-agent` — walk the decisions (`AGENT_ANATOMY.md` §1) |
...
design. A worktree is not a sandbox (`AGENT_ANATOMY.md` §4). Runtime authority — spend, send,
